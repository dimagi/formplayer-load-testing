...
from task_sets.navigate_menu import CaseListTask, NikshayCaseListTask, MultiUserCaseListTask
...
class MultiUserCaseListLocust(HttpLocust):
    task_set = MultiUserCaseListTask
    min_wait = 1000
    max_wait = 1000
